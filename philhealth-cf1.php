    ...
    <script>
        ...
        (function () {
                ...
                try {
                    ...
                    if (!existing && pid) {
                        (async () => {
                            ...
                            const res = await fetch('api/philhealth/member_claim.php?' + qs, { headers: { 'Accept': 'application/json' } });
            ...
            (async () => {
                ...
                try {
                    const res = await fetch('api/philhealth/member_cf1.php?' + qs, { headers: { 'Accept': 'application/json' } });
                    const json = await res.json().catch(() => null);
