...
(function() {
    ...
    function qecLoadRecentTransfers() {
        ...
        fetch('api/queue/recent-transfers/' + STATION_ID)
            .then(r => r.json())
            .then(data => {
    ...
    function qecCheckPendingCorrections() {
        fetch('api/queue/pending-corrections/' + STATION_ID)
            .then(r => r.json())
            .then(data => {
    ...
    window.qecConfirmCorrection = function(errorLogId) {
        ...
        fetch('api/queue/confirm-correction', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    // Poll for pending corrections every 5 seconds
