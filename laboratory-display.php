...
<head>
    ...
    <title>Laboratory Queue Display - Hospital System</title>
    ...
    <div class="display-container">
        <div class="header-section">
            <div class="flex justify-between items-center">
                ...
                <div>
                    <h1 class="station-title">Laboratory Department</h1>
...
Lanao Del Sur, BARMM 9300
    ...
    <script>
        ...
        async function loadQueueData() {
            try {
                const response = await fetch('api/queue/display/6');
        ...
        function announcePatient(name) {
            if ('speechSynthesis' in window) {
                ...
                const utterance = new SpeechSynthesisUtterance('Patient ' + name + ', please proceed to the Laboratory');
    ...
    <script>window.qecDisplayStationId = 6;</script>
