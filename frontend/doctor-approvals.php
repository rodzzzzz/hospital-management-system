...
<body class="bg-gray-50">
    ...
    <script>
        ...
        async function loadPending() {
            ...
            const res = await fetch(API_BASE_URL + '/lab/list_requests.php?mode=doctor&status=pending_approval', { headers: { 'Accept': 'application/json' } });
        ...
        async function act(action, reason = '') {
            ...
            const res = await fetch(API_BASE_URL + '/lab/approve.php', {
                method: 'POST',
