...
<head>
    ...
    <title>Pharmacy Queue Display - Hospital System</title>
    ...
    <div class="display-container">
        ...
        <div class="header-section">
            <div class="flex justify-between items-center">
                ...
                <div>
                    <h1 class="station-title">Pharmacy Department</h1>
...
Lanao Del Sur, BARMM 9300
    ...
    <script>window.qecDisplayStationId = 3;</script>
    <?php include __DIR__ . '/includes/queue-error-correction-display.php'; ?>
    <script>window.qrrDisplayStationId = 3;</script>
