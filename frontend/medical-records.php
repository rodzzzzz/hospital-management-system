...
<body class="bg-gray-50">
    ...
    <script>
        ...
        async function mrResolveLatestEncounter(patientId) {
            ...
            const url = API_BASE_URL + '/encounters/list.php?patient_id=' + encodeURIComponent(String(pid)) + '&status=open';
            ...
            const url2 = API_BASE_URL + '/encounters/list.php?patient_id=' + encodeURIComponent(String(pid));
        ...
        async function mrResolveLatestEncounterForTab(patientId, tab) {
            ...
            const { res, json } = await mrFetchJson(API_BASE_URL + '/encounters/list.php?patient_id=' + encodeURIComponent(String(pid)));
            if (res.ok && json && json.ok && Array.isArray(json.encounters) && json.encounters.length > 0) {
        ...
        async function mrResolveLatestEncounterByType(patientId, type) {
            ...
            const url = API_BASE_URL + '/encounters/list.php?patient_id=' + encodeURIComponent(String(pid)) + '&status=open&type=' + encodeURIComponent(t);
            const { res, json } = await mrFetchJson(url);
            if (res.ok && json && json.ok && Array.isArray(json.encounters) && json.encounters.length > 0) {
                const e = json.encounters[0];
                if (e && e.id) {
            ...
            const url2 = API_BASE_URL + '/encounters/list.php?patient_id=' + encodeURIComponent(String(pid)) + '&type=' + encodeURIComponent(t);
            const { res: res2, json: json2 } = await mrFetchJson(url2);
            if (res2.ok && json2 && json2.ok && Array.isArray(json2.encounters) && json2.encounters.length > 0) {
                const e = json2.encounters[0];
                if (e && e.id) {
        ...
        async function mrLoadPatientsDropdown(q) {
            ...
            const { res, json } = await mrFetchJson(API_BASE_URL + '/patients/list.php?q=' + encodeURIComponent(query));
        ...
        async function mrLoadEncounters() {
            ...
            const { res, json } = await mrFetchJson(API_BASE_URL + '/encounters/list.php?patient_id=' + encodeURIComponent(String(p.id)));
            if (!res.ok || !json || !json.ok) {
                tbody.innerHTML = '';
        ...
        async function mrCloseEncounter(id) {
            ...
            const { res, json } = await mrFetchJson(API_BASE_URL + '/encounters/close.php', {
                method: 'POST',
        ...
        async function mrDeleteEncounter(id) {
            ...
            const { res, json } = await mrFetchJson(API_BASE_URL + '/encounters/delete.php', {
                method: 'POST',
                headers: { 'Accept': 'application/json', 'Content-Type': 'application/json' },
                body: JSON.stringify({ encounter_id: encId }),
            });
        ...
        async function mrCreateEncounter() {
            ...
            const { res, json } = await mrFetchJson(API_BASE_URL + '/encounters/create.php', {
                method: 'POST',
                headers: { 'Accept': 'application/json', 'Content-Type': 'application/json' },
        ...
        async function mrOpenLabRequest(id) {
            ...
            const { res, json } = await mrFetchJson(API_BASE_URL + '/lab/get_request.php?id=' + encodeURIComponent(String(id)));
            if (!res.ok || !json || !json.ok) {
        ...
        async function mrOpenInvoice(id) {
            ...
            const { res, json } = await mrFetchJson(API_BASE_URL + '/cashier/get_invoice.php?invoice_id=' + encodeURIComponent(String(id)));
            if (!res.ok || !json || !json.ok) {
                if (sub) sub.textContent = '';
        ...
        async function mrLoadErForms() {
            ...
            const url = API_BASE_URL + '/lab/list_requests.php?mode=er&patient_id=' + encodeURIComponent(String(p.id)) + '&encounter_id=' + encodeURIComponent(String(e.id));
            const { res, json } = await mrFetchJson(url);
            if (!res.ok || !json || !json.ok) {
                tbody.innerHTML = '';
        ...
        async function mrLoadLabResults() {
            ...
            const url = API_BASE_URL + '/lab/list_requests.php?patient_id=' + encodeURIComponent(String(p.id)) + '&encounter_id=' + encodeURIComponent(String(e.id));
            const { res, json } = await mrFetchJson(url);
            if (!res.ok || !json || !json.ok) {
                tbody.innerHTML = '';
        ...
        async function mrLoadResita() {
            ...
            tbody.innerHTML = '<tr><td colspan="5" class="px-6 py-6 text-sm text-gray-500">Loading...</td></tr>';
            const url = API_BASE_URL + '/pharmacy/list_resits.php?patient_id=' + encodeURIComponent(String(p.id)) + '&encounter_id=' + encodeURIComponent(String(e.id));
            const { res, json } = await mrFetchJson(url);
            if (!res.ok || !json || !json.ok) {
                tbody.innerHTML = '';
        ...
        async function mrLoadBilling() {
            ...
            const invUrl = API_BASE_URL + '/cashier/list_invoices.php?patient_id=' + encodeURIComponent(String(p.id)) + '&encounter_id=' + encodeURIComponent(String(e.id));
            const payUrl = API_BASE_URL + '/cashier/list_payments.php?patient_id=' + encodeURIComponent(String(p.id)) + '&encounter_id=' + encodeURIComponent(String(e.id));
        ...
        async function mrLoadDashboard() {
            ...
            const erUrl = API_BASE_URL + '/lab/list_requests.php?mode=er&patient_id=' + encodeURIComponent(String(p.id)) + '&encounter_id=' + encodeURIComponent(String(e.id));
            const labUrl = API_BASE_URL + '/lab/list_requests.php?patient_id=' + encodeURIComponent(String(p.id)) + '&encounter_id=' + encodeURIComponent(String(e.id));
            const resitUrl = API_BASE_URL + '/pharmacy/list_resits.php?patient_id=' + encodeURIComponent(String(p.id)) + '&encounter_id=' + encodeURIComponent(String(e.id));
            const invUrl = API_BASE_URL + '/cashier/list_invoices.php?patient_id=' + encodeURIComponent(String(p.id)) + '&encounter_id=' + encodeURIComponent(String(e.id));
