...
<body class="bg-gray-50">
    ...
    <script>
        ...
        async function loadDepartments() {
            const res = await fetch(API_BASE_URL + '/hr/departments/list.php', { headers: { 'Accept': 'application/json' } });
        ...
        async function loadPositions(departmentId) {
            ...
            const url = API_BASE_URL + '/hr/positions/list.php' + (params.toString() ? ('?' + params.toString()) : '');
        ...
        function buildListUrl() {
            ...
            return API_BASE_URL + '/hr/employees/list.php' + (qs ? ('?' + qs) : '');
        }
        ...
        async function saveEmployee() {
            ...
            const endpoint = isEdit ? API_BASE_URL + '/hr/employees/update.php' : API_BASE_URL + '/hr/employees/create.php';
        ...
        async function deleteEmployee(id) {
            ...
            try {
                const res = await fetch(API_BASE_URL + '/hr/employees/delete.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' },
