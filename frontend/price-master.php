...
<body class="bg-gray-50">
    ...
    <script>
        ...
        async function loadLabCatalog() {
            ...
            const res = await fetch(API_BASE_URL + '/lab/list_catalog.php', { headers: { 'Accept': 'application/json' } });
        ...
        async function loadOpdFees() {
            ...
            const res = await fetch(API_BASE_URL + '/price_master/list_opd_fees.php', { headers: { 'Accept': 'application/json' } });
            const json = await res.json().catch(() => null);
        ...
        async function saveLabFee() {
            ...
            const res = await fetch(API_BASE_URL + '/price_master/save_lab_fee.php', {
                method: 'POST',
        ...
        async function saveOpdFee() {
            ...
            const res = await fetch(API_BASE_URL + '/price_master/save_opd_fee.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' },
