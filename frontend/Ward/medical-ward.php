...
<head>
    ...
    <title>Medical Ward - Hospital System</title>
    ...
    <div class="min-h-screen">
        ...
        <main class="ml-64 p-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Medical Ward</h1>
                    <p class="text-sm text-gray-600 mt-1">Daily patient bed monitoring - Internal Medicine</p>
                </div>
                <div class="flex gap-3">
                    ...
                    <button type="button" id="btnRefreshMedical" class="px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors">
            ...
            <div id="ward-a" class="ward-content">
                <div class="bg-white rounded-lg shadow p-6 mb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Medical Ward A - Bed Overview</h2>
            ...
            <div id="ward-b" class="ward-content hidden">
                <div class="bg-white rounded-lg shadow p-6 mb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Medical Ward B - Bed Overview</h2>
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full">
                ...
                <form id="vitalsForm" class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Blood Glucose (mg/dL)</label>
                            <input type="number" name="blood_glucose" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="100">
                        </div>
                    </div>
                    <div class="mb-4">
    ...
    <script>
            ...
            'ward-a': [
                {
                    ...
                    vitals: {
                        ...
                        oxygenSaturation: 96,
                        bloodGlucose: 145,
                        lastUpdated: '2026-02-28 14:15'
                    },
                    treatment: 'Insulin therapy, Blood glucose monitoring q4h, Diabetic diet',
                    notes: []
                },
                {
                    id: 2,
                    ...
                    vitals: {
                        ...
                        oxygenSaturation: 92,
                        bloodGlucose: 110,
                        lastUpdated: '2026-02-28 15:30'
                    },
                    treatment: 'Diuretics, ACE inhibitors, Oxygen therapy, Fluid restriction',
                    notes: []
                },
                {
                    id: 3,
                    ...
                    treatment: 'Renal diet, Phosphate binders, EPO injections, Dialysis prep',
                    notes: []
                }
            ],
            'ward-b': [
                {
                    ...
                    treatment: 'IV Antibiotics (non-penicillin), Bronchodilators, O2 2L/min',
                    notes: []
                },
                {
                    id: 12,
                    ...
                    vitals: {
                        ...
                        oxygenSaturation: 93,
                        bloodGlucose: 180,
                        lastUpdated: '2026-02-28 15:45'
                    },
                    treatment: 'NPO, IV fluids, Pain management, Lipase monitoring',
                    notes: []
                }
            ]
        };
        ...
        for (let i = 4; i <= 10; i++) {
            bedsData['ward-a'].push({
                id: i,
                bedNumber: `M-A-${String(i).padStart(2, '0')}`,
                status: 'available',
                patient: null
            });
        }
        ...
        for (let i = 3; i <= 10; i++) {
            bedsData['ward-b'].push({
                id: 10 + i,
                bedNumber: `M-B-${String(i).padStart(2, '0')}`,
                status: 'available',
                patient: null
            });
        }
        ...
        function setupEventListeners() {
            ...
            // Refresh button
            document.getElementById('btnRefreshMedical').addEventListener('click', function() {
                loadWardBeds(currentWard);
                updateStatistics();
            });
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div class="bg-yellow-50 p-4 rounded-lg text-center">
                                <i class="fas fa-vial text-yellow-600 text-2xl mb-2"></i>
                                <p class="text-sm text-gray-600">Blood Glucose</p>
                                <p class="text-xl font-bold text-gray-900">${vitals.bloodGlucose} mg/dL</p>
                            </div>
                        </div>
                        <div class="mt-4 bg-gray-50 p-3 rounded-lg text-center">
                            <i class="fas fa-clock text-gray-600 mr-2"></i>
                            <span class="text-sm text-gray-600">Last Updated: </span>
                            <span class="text-sm font-semibold text-gray-900">${vitals.lastUpdated}</span>
                        </div>
                    </div>
        ...
        function openVitalsModal(bedId) {
            ...
            if (bed.vitals) {
                ...
                if (bed.vitals.bloodGlucose) {
                    document.querySelector('#vitalsForm input[name="blood_glucose"]').value = bed.vitals.bloodGlucose;
                }
            }
