...
Lanao Del Sur, BARMM 9300
    ...
    <script>
        ...
        function announcePatient(name) {
            if ('speechSynthesis' in window) {
                ...
                const utterance = new SpeechSynthesisUtterance('Patient ' + name + ', please proceed to the X-Ray Department');
    ...
    <script>window.qecDisplayStationId = 5;</script>
    <?php include __DIR__ . '/includes/queue-error-correction-display.php'; ?>
    <script>window.qrrDisplayStationId = 5;</script>
