...
<head>
    ...
    <title>Cashier Queue Display - Hospital System</title>
    ...
    <div class="display-container">
        ...
        <div class="header-section">
            <div class="flex justify-between items-center">
                ...
                <div>
                    <h1 class="station-title">Cashier Department</h1>
...
Lanao Del Sur, BARMM 9300
    ...
    <script>
        ...
        function announcePatient(name) {
            if ('speechSynthesis' in window) {
                ...
                const utterance = new SpeechSynthesisUtterance('Patient ' + name + ', please proceed to the Cashier');
    ...
    <script>window.qrrDisplayStationId = 4;</script>
