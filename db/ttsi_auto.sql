...
-- 6. Queue Return Requests Table (receiver-initiated corrections / Reverse QEC)
CREATE TABLE IF NOT EXISTS `queue_return_requests` (
  ...
  KEY `idx_qrr_patient_id` (`patient_id`),
  KEY `idx_qrr_requesting_station_id` (`requesting_station_id`),
  KEY `idx_qrr_origin_station_id` (`origin_station_id`),
  KEY `idx_qrr_suggested_station_id` (`suggested_station_id`),
  KEY `idx_qrr_status` (`status`),
  KEY `idx_qrr_requested_at` (`requested_at`),
