    ...
    <script>
        ...
        async function openExistingClaimForms(patientId) {
            ...
            try {
                ...
                const res = await fetch('api/philhealth/member_claim.php?patient_id=' + encodeURIComponent(String(pid)), {
        ...
        async function proceedToCF1() {
            ...
            try {
                ...
                if (!isEditExisting) {
                    ...
                    const pinRes = await fetch('api/philhealth/pin_exists.php?pin=' + encodeURIComponent(payload.philhealthId), {
                ...
                const startRes = await fetch('api/philhealth/claim_session.php', {
                ...
                if (isEditExisting) {
                    ...
                    if (editCtx && editCtx.loaded === true && editCtx.cache) {
                        ...
                        const claimRes = await fetch('api/philhealth/member_claim.php?patient_id=' + encodeURIComponent(String(editPatientId)), {
                            headers: { 'Accept': 'application/json' },
                        });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const fetchClaimActive = async () => {
                ...
                try {
                    ...
                    const res = await fetch('api/philhealth/claim_session.php', { headers: { 'Accept': 'application/json' } });
            ...
            const startNewClaimDirect = async () => {
                ...
                try {
                    ...
                    await fetch('api/philhealth/claim_session.php', {
            ...
            async function loadPhilhealthDashboard() {
                ...
                try {
                    ...
                    const res = await fetch('api/philhealth/dashboard.php', { headers: { 'Accept': 'application/json' } });
