                            ...
                            (function () {
                                ...
                                if (!patientId && !pin) {
                                    try {
                                        ...
                                        if (!existing && pid) {
                                            (async () => {
                                                const res = await fetch('api/philhealth/member_claim.php?patient_id=' + encodeURIComponent(pid), { headers: { 'Accept': 'application/json' } });
                                ...
                                if (patientId || pin) {
                                    (async () => {
                                        ...
                                        const res = await fetch('api/philhealth/member_cf4.php?' + qs, { headers: { 'Accept': 'application/json' } });
                                        const json = await res.json().catch(() => null);
                                ...
                                async function saveToDb() {
                                    ...
                                    try {
                                        ...
                                        await fetch('api/philhealth/install.php', {
                                            headers: { 'Accept': 'application/json' },
                                        });

                                        const res = await fetch('api/philhealth/save.php', {
                                            method: 'POST',
                                            headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' },
                            ...
                            (function () {
                                ...
                                if (cancelBtn) {
                                    cancelBtn.addEventListener('click', () => {
                                        ...
                                        fetch('api/philhealth/claim_session.php', {
                                            method: 'POST',
                                            headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' },
                                            body: JSON.stringify({ action: 'cancel' }),
                                        }).catch(() => { });
        ...
        (function () {
            ...
            btn.addEventListener('click', async () => {
                ...
                try {
                    ...
                    const installRes = await fetch('api/philhealth/install.php', {
                        headers: { 'Accept': 'application/json' },
                    });
