...
<body class="bg-gray-50">
    ...
    <script>
        ...
        function buildDeptListUrl() {
            ...
            return 'api/hr/departments/list.php' + (qs ? ('?' + qs) : '');
        }
        ...
        function buildPosListUrl() {
            ...
            if (status) params.set('status', status);
            const qs = params.toString();
            return 'api/hr/positions/list.php' + (qs ? ('?' + qs) : '');
        }
        ...
        async function saveDept() {
            ...
            const endpoint = isEdit ? 'api/hr/departments/update.php' : 'api/hr/departments/create.php';
        ...
        async function deleteDept(id) {
            ...
            const res = await fetch('api/hr/departments/delete.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' },
        ...
        async function savePos() {
            ...
            const endpoint = isEdit ? 'api/hr/positions/update.php' : 'api/hr/positions/create.php';
        ...
        async function deletePos(id) {
            ...
            const res = await fetch('api/hr/positions/delete.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' },
