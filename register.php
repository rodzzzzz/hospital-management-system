...
<body class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100">
            <div class="text-xl font-bold text-gray-900">Register</div>
            <div class="text-sm text-gray-600 mt-1">Create an account. HR will assign your access later.</div>
        </div>
        <div class="p-6">
            ...
            <form id="registerForm" class="space-y-4">
                ...
                <button type="submit" class="w-full px-4 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white shadow-sm">Create account</button>
            </form>
            <div class="mt-4 text-sm text-gray-600">
                Already have an account?
                <a href="login.php" class="text-blue-700 hover:underline">Login</a>
            </div>
        </div>
    </div>
    ...
    <script>
        (function () {
            ...
            form.addEventListener('submit', async function (e) {
                ...
                setMsg('ok', 'Registered. You can now login.');
