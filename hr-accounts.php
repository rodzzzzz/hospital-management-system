...
<body class="bg-gray-50">
    ...
    <script>
        ...
        async function searchUnassignedUsers(q) {
            ...
            const url = 'api/users/list.php?unassigned=1&q=' + encodeURIComponent(needle);
        ...
        async function ensureTables() {
            try {
                await fetch('api/users/install.php', {
                    method: 'POST',
        ...
        function buildListUrl() {
            ...
            return 'api/users/list.php' + (qs ? ('?' + qs) : '');
        }
        ...
        function attachEvents() {
            ...
            if (btnSeed) {
                btnSeed.addEventListener('click', async () => {
                    ...
                    try {
                        const res = await fetch('api/admin/seed_test_accounts.php', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' },
                            body: JSON.stringify({})
                        });
