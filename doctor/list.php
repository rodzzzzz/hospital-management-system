...
try {
    ...
    if (empty($doctors)) {
        ...
        if ($userCheck == 0) {
            ...
            $sampleDoctors = [
                ['full_name' => 'Delivery Room Staff', 'username' => 'dr.staff'],
                ['full_name' => 'Doctor', 'username' => 'doctor'],
                ['full_name' => 'Doctor2', 'username' => 'doctor2'],
                ['full_name' => 'Doctor3', 'username' => 'doctor3'],
                ['full_name' => 'Operating Room Staff', 'username' => 'or.staff']
            ];
