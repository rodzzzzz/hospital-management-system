...
<head>
    ...
    <style>
        ...
        .soft-lines {
            background-image:
                linear-gradient(180deg, rgba(255, 255, 255, 0.88) 0%, rgba(255, 255, 255, 0.94) 46%, rgba(255, 255, 255, 1) 76%),
            ...
            background-position: top center, 0 0, 0 0, top center;
...
<body class="min-h-screen bg-slate-200 flex items-center justify-center p-4">
    <div class="mobile-frame w-full max-w-[420px] h-[820px] max-h-[calc(100vh-2rem)] bg-white shadow-2xl overflow-hidden mobile-surface flex flex-col">
        <div class="px-8 pt-20 pb-12 soft-lines flex-1 overflow-y-auto no-scrollbar">
            <div class="flex items-center justify-center">
                <div class="w-[86px] h-[86px] rounded-full bg-white shadow-md flex items-center justify-center overflow-hidden">
                    <img id="doctorMobileLogo" src="../logo.png" alt="Logo" class="w-[64px] h-[64px] object-contain" />
